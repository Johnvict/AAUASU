...
<div class="modal-content">
    <div class="modal-header">
        <h4 class="modal-title"><b>100 LEVEL COURSES</b></h4>
    </div>
    <div class="modal-body alert alert-info">
        @php $thisCount = 0 @endphp
        @foreach($myCourses as $myCourse)
            @if($myCourse->level == 100)
                    ...
                    @foreach($myCourses as $myCourse)
                        @if($myCourse->level == 100)
                            ...
                            <tr>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p class="text-center">Are you sure you want to remove {{$myCourse->code}} from {{$myCourse->level}} level courses?<br>
                                ...
                                <td class="">
                                    <a href="#updateGrade{{$myCourse->id}}" class="label label-info" data-toggle="collapse"><b>Update Grade</b></a>
